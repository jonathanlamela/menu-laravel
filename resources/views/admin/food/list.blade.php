        ...
        <div class="col-lg-3 mt-3 mt-md-0">
            <form class="m-0">
                <div class="input-group">
                    <input type="text" class="form-control" name="search" placeHolder="Cerca un cibo"
                    ...
                    <tr>
                        ...
                        <td class="col-lg-4 text-center">
                            <a class="text-decoration-none badge bg-secondary text-bg-dark p-2"
                                href="{{ route('admin.food.edit', ['food' => $item->id]) }}"><i
                                    class="bi bi-pencil-square"></i>
                                Modifica</a>
                            <a class="text-decoration-none badge bg-danger text-bg-dark p-2"
                                href="{{ route('admin.food.delete', ['food' => $item->id]) }}"><i class="bi bi-trash"></i>
                                Elimina</a>
                        </td>
                    </tr>
                @endforeach
