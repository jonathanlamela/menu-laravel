    ...
    <div class="flex flex-col pt-4 px-8 flex-grow">
        ...
        <form class="flex-col space-y-2" method="post">
            ...
            <div class="w-1/3 flex flex-col space-y-2">
                ...
                <input type="text" name="site_title" value="{{ $item->site_title }}"
                    class="text-input @error('site_title') text-input-invalid @enderror" />
                @error('site_title')
            ...
            <div class="w-1/3 flex flex-col space-y-2">
                ...
                <input type="text" name="site_subtitle" value="{{ $item->site_subtitle }}" class="text-input" />
            </div>
