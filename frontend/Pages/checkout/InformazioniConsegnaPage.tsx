...
export default function InformazioniConsegnaPage() {
    ...
    const { indirizzo, orario } = page.props.cart;
            ...
            <div className="p-8">
                <div className="flex flex-col flex-grow space-y-4">
                    <div className="w-full md:w-1/2">
                        <Link href="/checkout/tipologia-consegna"><h5 className="font-semibold text-lg border-b-slate-300 border-b-2 pb-2">1. Consegna ordine</h5></Link>
                    </div>
                    <div className="w-full md:w-1/2">
