...
export default function AdminFoodListPage() {
    ...
    const pageData = usePage<Page<{ perPage: number, page: number, ascending: boolean, searchKey: string, foods: any[], count: number, orderBy: string }>>();

    const [isPending, setIsPending] = useState(false);

    const { ascending, foods, count, page, perPage, searchKey, orderBy } = pageData.props;
        ...
        <BaseLayout title="Cibi">
            ...
            <div className="flex flex-col p-8 flex-grow">
                ...
                <div className="w-full bg-slate-500 p-4">
                    <p className="text-xl antialiased text-white">Cibi</p>
                </div>
                <div className="flex w-full bg-gray-100 p-2">
                    <div className="w-1/2">
                        <div className="flex">
                            <Link href="/amministrazione/cibi/crea" className="btn-primary">Crea</Link>
                        </div>
                    </div>
